package com.ms365.middleware.zuulserver.common.constants;
...
public class Constants {
  ...
  final public static class Security{
    final public static String ISSUER_INFO              = "https://www.empresa365.com/";
    final public static String URI_PATH_REG_EXP_PATTERN = "([/|?]?[a-zA-Z0-9\\-._~%!$&'()*+,;=@]+)*";
    ...
    final public static class Headers{
      ...
      final public static String AUTHORIZATION_EXPIRATION_SECONDS = "Authorization-Expiration-Seconds";
    }

    final public static class Token{
      final public static long EXPIRATION_TIME = 1800;  // 30 mins
      final public static String BEARER_PREFIX = "Bearer";
    }
  }
}
