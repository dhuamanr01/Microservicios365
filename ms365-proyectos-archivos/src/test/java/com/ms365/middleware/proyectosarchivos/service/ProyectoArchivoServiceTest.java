...
@SpringBootTest
@Ignore
public class ProyectoArchivoServiceTest {
  private static Logger logger = LoggerFactory.getLogger(ProyectoArchivoServiceTest.class);

  @Autowired(required=true)
  private ProyectoArchivoService proyectoArchivoService;

  public ProyectoArchivoServiceTest() {}
  ...
  public void testFindAll() {
    ...
    try {
      ...
      for (ProyectoArchivoDTO dto : list) {
        logger.info("   >> " + dto);
      }
    }
    catch (Exception ex) {
